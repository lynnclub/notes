...
阿里云百炼coding plan  
国内最便宜，￥40/月（已停售），500次/5h，只支持国产模型，GLM-5用到爽，IDE支持lingma、vscode

copilot  
国外最便宜  
Pro套餐$10/月，无限制使用GPT-5 mini、GPT-4o、GPT-4.1，IDE支持copilot、vscode，而且唯一凑齐openai、google、claude御三家，待体验  
https://github.com/features/copilot/plans#footnote-1

kiro  
主打自研spec，分为需求分析、技术设计、任务列表  
新注册送500点，新老用户还送50点/月（包括Sonnet 4.5）  
付费套餐在高级模型上比copilot便宜些  
https://kiro.dev
...
ChatGPT plus套餐$20/月，额度非常高，很难用完，但是使用非openai模型要单独付费并设置
